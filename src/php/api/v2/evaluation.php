...
$query = "SELECT evaluation.*, d.name AS 'drill_name', d.allowed_tries AS 'allowed_tries', d.success_treshold AS 'success_treshold', a.first_name AS 'athlete_first_name', a.name AS 'athlete_name'  FROM evaluation JOIN drill d ON evaluation.drill = d.id JOIN athlete a ON evaluation.athlete = a.id";
if (isGet()) {
