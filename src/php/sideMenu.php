...
<div class="sideMenu col2 colt2 colm12 floatLeft fixed">
    ...
    <a class="sideMenuButton<?php checkURI("/UIWDrillManager.php") ?>"
        href="./UIWDrillManager.php">Épreuves</a>
    <a class="sideMenuButton<?php checkURI("/UIWCourseManager.php") ?>"
        href="./UIWCourseManager.php">Parcours</a>
    <a class="sideMenuButton<?php checkURI("/manageCap.php") ?>"
        href="./manageCap.php">Casquettes</a>
    <a class="sideMenuButton<?php checkURI("/logout.php") ?>"
