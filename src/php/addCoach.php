<?php
/**************************************************************************************
Fichier :       addCoach.php
Auteur :        Olivier Lemay Dostie
Fonctionnalité : Permet d'ajouter un évaluateur.
Date :          6 mai 2018
=======================================================================================
Vérification :
Date		Nom					    Approuvé
...
if(isPost()) {
    if(isPostSetAndNotEmpty('id') && isPostSetAndNotEmpty('firstname')
        ...
        try {
            CoachManager::insertFromAttributes(
                (int)$_POST['id'], (int)$_POST['address'], (int)$_POST['gender'],
...
<head>
    ...
    <title>Ajouter un évaluateur</title>
    <link rel="stylesheet" type="text/css" href="./css/stylesheet.css">
    <script src="js/person.js"></script>
</head>

<body class="modal-content animate padding30">
<h3>Ajout d'un évaluateur</h3><br>
<form name="coachFrm" onsubmit="return validateForm('coachFrm')" action="" method="post">
    ...
    <button type="submit" class="buttonGreen">Ajouter l'évaluateur</button>
</form>
</body>
</html>
